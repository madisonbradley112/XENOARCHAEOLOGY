...
/*  
    ...
    8: 64 pages
        Micro
*/
const BGCOLOR = '#6aeb3b'; // Change this hex value to set the background color. Remember to keep the quotes!
const ALT = 'XENOARCHAEOLOGIST: A zine about an alien archeologist visiting Earth'; // Change this to a plaintext copy or description of your content to make it visible to screen-readers
const SMOOTH = false; // Set to false if you want crispy pixels. Leave true if you like the blur.
